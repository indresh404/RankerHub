...
const LANGUAGES = [
  ...
  },
  {
    id: "cpp",
    label: "C++",
    color: "bg-pink-500/10 text-pink-600 dark:text-pink-400 border-pink-500/25",
  },
  {
    id: "ruby",
    label: "Ruby",
...
const STATIC_FALLBACK_ISSUES = [
  {
    ...
    labels: [
      ...
      { name: "component: dark-mode", color: "fbca04" },
    ],
    user: {
      login: "gaearon",
      avatar_url: "https://github.com/identicons/gaearon.png",
    },
  },
  {
    id: 102,
    ...
    labels: [
      ...
      { name: "cleanup", color: "0052cc" },
    ],
    user: {
      login: "tiangolo",
      avatar_url: "https://github.com/identicons/tiangolo.png",
    },
  },
  {
    id: 103,
    ...
    labels: [
      ...
      { name: "p2", color: "8f8f8f" },
    ],
    user: {
      login: "kamilmysliwiec",
      avatar_url: "https://github.com/identicons/kamilmysliwiec.png",
    },
  },
];
...
export const Matchmaker = () => {
  ...
  const [bookmarks, setBookmarks] = useState(() => {
    const cached = localStorage.getItem(
      `matchmaker_bookmarks_${user?.uid || "guest"}`,
    );
  ...
  const fetchIssues = useCallback(async () => {
    ...
    try {
      ...
      if (status === 403 || status === 429) {
        ...
        setError(
          "GitHub API rate limit exceeded. Displaying placeholder recommendation issues.",
        );
      } else {
  ...
  const isBookmarked = (issueId) =>
    bookmarks.some((item) => item.id === issueId);
              ...
              <div className="grid grid-cols-1 gap-1.5">
                {DIFFICULTIES.map((diff) => (
                  ...
                  >
                    ...
                    <span
                      className={`px-1.5 py-0.5 rounded text-[8px] uppercase tracking-wider font-extrabold ${diff.color}`}
                    >
                      {diff.id}
                    </span>
                  </button>
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {rateLimited && (
            <div className="flex items-center gap-2 p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-amber-600 dark:text-amber-400 text-xs font-bold">
              ...
              <span>
                GitHub API rate limit reached. Displaying simulated backup
                challenges. Verify your auth connection later.
              </span>
            </div>
          )}
            ...
            <AnimatePresence mode="wait">
                ...
                issues.length === 0 ? (
                  ...
                  >
                    ...
                    <p className="text-xs max-w-xs mx-auto leading-relaxed font-medium">
                      Try broadening your custom keywords filter or choosing
                      ...
                      >
                        <div className="space-y-2 flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 text-[10px] text-slate-400 font-bold uppercase tracking-wider">
                            ...
                            <span>/</span>
                            <span className="text-slate-550 dark:text-slate-350 hover:underline cursor-pointer font-extrabold">
              ...
              bookmarks.length === 0 ? (
                ...
                >
                  ...
                  <p className="text-xs max-w-xs mx-auto leading-relaxed font-medium">
                    Bookmark issues in the Explore tab to save them for easy
                    ...
                    >
                      <div className="space-y-2 flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 text-[10px] text-slate-400 font-bold uppercase tracking-wider">
                          ...
                          <span>/</span>
                          <span className="text-slate-550 dark:text-slate-350 font-extrabold">
                            {issue.repository?.name}
                          </span>
                        </div>
